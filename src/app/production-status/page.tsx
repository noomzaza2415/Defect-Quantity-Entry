...
import ProductionSummary from "@/components/ProductionStatus/page";

// นำ Dashboard ที่คุณเขียนไว้มา import ตรงนี้
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Production Status</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
