...
const sidebarMenuButtonVariants = cva(
  ...
  // เปลี่ยนสีเป็นฟ้าอ่อนนวลๆ (blue-100) และตัวหนังสือเป็นสีน้ำเงินเข้ม (blue-900)
  "data-active:bg-blue-100 data-active:text-blue-900 data-active:font-semibold " + 
  "[&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
        // ให้ hover เป็นสีฟ้าที่จางกว่าเพื่อความสวยงาม
        default: "hover:bg-blue-50 hover:text-blue-700", 
        outline:
          "bg-background shadow-[0_0_0_1px_var(--sidebar-border)] hover:bg-blue-50 hover:text-blue-700",
      },
      size: {
        default: "h-8 text-sm",
        sm: "h-7 text-xs",
